function [EquationParas,index,Reason] = AutomaticRPAIdentification(SaveNetworkName,Monomials,KnownMonomials,FullEquation,GroebnerBasisEquations,Species)
...
for i = 1:size(Monomials,1)
    ...
    elseif has(TempMonomial,Species(1:end-1))
        Reason(i) = 1;
    end
